...
def correlation_based_neighbourhood_model(mat, mat_file, l_reg2=100.0, k=250,u_id = 15):
...
if __name__ == "__main__":
    ...
    print(mat.shape)
    r_ui_mat,target = correlation_based_neighbourhood_model(mat, mat_file)
    # # print(r_ui_mat)
    out_path_1 = "Datasets/rui.mat"
    io.savemat(out_path_1, {'X' : r_ui_mat})
    print(target)
